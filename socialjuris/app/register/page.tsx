    ...
    <div className="flex min-h-screen items-center justify-center bg-gray-100">
      <div className="w-full max-w-md p-8 bg-white rounded shadow-md">
        ...
        <button
          ...
          className="w-full mb-4 py-2 px-4 bg-[#1877F2] hover:bg-[#166fe5] text-white font-bold rounded transition flex items-center justify-center gap-2"
        >
        ...
        <div className="flex items-center my-4">
          ...
          <span className="px-3 text-gray-500 text-sm">ou use seu email</span>
          <div className="flex-1 border-t border-gray-300"></div>
        </div>
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          <div>
            ...
            <input
              ...
              required
              className="mt-1 w-full p-2 border rounded outline-none text-gray-900 focus:ring-2 focus:ring-blue-500"
          ...
          <div>
            ...
            <select
              ...
              value={formData.tipo}
              onChange={handleChange}
              className="mt-1 w-full p-2 border rounded outline-none text-gray-900 focus:ring-2 focus:ring-blue-500 bg-white"
            >
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-2 px-4 bg-green-600 hover:bg-green-700 text-white font-semibold rounded transition disabled:opacity-50 mt-4"
          >
